<div id="n1">
        ...
        <ul>
            ...
            <li><a class="btn" id="a1" href="admin_home.php"><i class="fa fa-home"></i> Home</a></li>
            <li><a class="btn" id="a1" href="learner.php"><img src="https://img.icons8.com/ios/21/000000/add-user-male-filled.png"> Add Learner</a></li>
            <li><a class="btn" id="a1" href="instructor.php"><img src="https://img.icons8.com/ios-glyphs/21/000000/add-user-male.png"> Add Instructor</a></li>
            <li><a class="btn" id="a1" href="#"><img src="https://img.icons8.com/pastel-glyph/21/000000/financial-tasks.png"> Manage Tasks</a></li>
            <li><a class="btn" id="a1" href="c_list.php"><img src="https://img.icons8.com/pastel-glyph/21/000000/books.png"> Manage Courses</a></li>
            <li><a class="btn" id="a1" href="Afeedback.php"><img src="https://img.icons8.com/ios/21/000000/normal-distribution-histogram.png"> Feedbacks</a></li>
...
<span class="navbar-toggler-icon">
        ...
        <ul class="nav navbar-nav navbar-right">
            ...
            <li class="nav-item">
            <a class="nav-link" href="admin_home.php"><i class="fa fa-home"></i></a>
            </li>
<p> <style>
.vl {
